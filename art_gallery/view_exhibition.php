...
$stmt = $conn->prepare("CALL DisplayExhibition()");
$stmt->execute();
...
<body>
    ...
    <div id="navbar" class="h-nav">
        ...
        <div>
            <ul class=" nav-list v-class">
                ...
                <li><a href="exhibition.php">Add to exhibtion</a></li>
    ...
    <div class="background">
        <div id="heading">
            <h2 class="det">Exhibtion Details</h2>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row['exhibition_title'] . "</td>";
