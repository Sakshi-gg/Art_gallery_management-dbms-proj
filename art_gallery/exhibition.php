...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("CALL InsertGallery(?, ?, ?, ?,?)");
    $stmt->bind_param("sssss", $exhibition_title, $start_date, $end_date,$artist_id,$gallery_id);
...
<body>
    ...
    <div id="navbar" class="h-nav">
        ...
        <div>
            <ul class=" nav-list v-class">
                ...
                <li><a href="view_exhibition.php">Display_Exhibition</a></li>
    ...
    <div id="form">
        ...
        <form method="post" action="exhibition.php">
            <ul>
                <li><input type="text" name="exhibition_title" id="cname" placeholder="Enter the title"></li>

                <li><input type="date" name="start_date" id="customer_id" placeholder="start_date"></li>

                <li><input type="date" name="end_date" id="address" placeholder="end_date"></li>
                
                <li><input type="text" name="artwork_id" id="address" placeholder="artwork_id"></li>
                
                <li><input type="text" name="gallery_id" id="address" placeholder="gallery_id"></li>


                <li id="button"><button type="submit">Add</button></li>
            </ul>
        </form>
    </div>
    <br>
