...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->bind_param("ss", $gallery_name, $location);

   
if ($stmt->execute()) {
    echo '<script>alert("New record created successfully");</script>';
    echo '<script>window.location.href = "view_gallery.php";</script>'; // Redirect to some_page.php after showing the popup
} else {
...
<body>
    ...
    <div id="navbar" class="h-nav">
        ...
        <div>
            <ul class=" nav-list v-class">
                ...
                <li><a href="view_gallery.php">Display_Gallery</a></li>
    ...
    <div id="form">
        ...
        <form method="post" action="gallery.php">
            <ul>
                <li><input type="text" name="gallery_name" id="cname" placeholder="enter gallery name"></li>

                <li><input type="text" name="location" id="customer_id" placeholder="location"></li>
